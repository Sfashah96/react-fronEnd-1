...
export default function TeamSection() {
  return (
    <div className="lg:px-40 md:px-6 px-4 py-12">
      <h2 className="text-3xl lg:text-4xl md:text-6xl font-semibold text-center text-gray-900">Meet our team</h2>
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-6 pb-12 pt-20">
        {teamData.map((team, index) => (
          <TeamCard imgSrc={team.imgSrc} title={team.title} info={team.info} />
        ))}
      </div>
    </div>
  );
