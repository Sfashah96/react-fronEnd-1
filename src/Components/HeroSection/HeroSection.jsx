...
export default function HeroSection(props) {
  ...
  return (
    <div class=" bg-slate-950 h-screen md:h-[600px] lg:h-screen lg:pb-52 lg:pl-36">
      <div className="mx-auto container relative px-6 pt-7 xl:px-0">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 items-center">
          <div className="xl:mt-8">
            <button className=" hover:opacity-90 flex items-center relative focus:outline-none justify-center mt-5 lg:mt-10 text-sm lg:text-base font-medium text-gray-500 p-2 lg:p-2">{props.name}</button>
