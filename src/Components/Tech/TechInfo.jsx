  ...
  return (
    <section className="techinfo lg:px-56 bg-gray-50 py-10 px-5">
      <div className="text">
        ...
        <p className="text-gray-700 mt-5 text-[16px] font-semibold lg:w-[600px]">Our team of experts is proficient in a wide range of technologies, ensuring we can deliver the best possible solution for your project. We work with the latest tools and frameworks to create high-quality, scalable, and secure products that meet your requirements.</p>
      </div>
        ...
        <div className="mainsection">
          ...
          <div className="itemsList flex flex-wrap gap-5 justify-start">
            {webFrameworks.frontend.frameworks.map((item, index) => (
              <div key={index} className="hover:bg-gray-300 cursor-pointer flex items-center gap-2 px-4 py-2 bg-gray-200 rounded-md" style={{width: 'fit-content'}}>
